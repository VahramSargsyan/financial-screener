# Financial Screener Project Governance

Governance family: **VAHRAM_APP_GOVERNANCE v0.4.9**  
Local profile: **FINANCIAL_ANALYTICS**  
Status: ACTIVE
...
Current project purpose: comparative company financial analysis using source data and reproducible notebooks.

Protect:
- existing notebooks/data outputs;
- metric definitions (ROS, liquidity ratios, etc.);
- source-data provenance;
- separation between raw data, derived metrics and narrative conclusions.

If this project is later absorbed into Investment Lab, migrate it as a module rather than rewriting or deleting its history.
